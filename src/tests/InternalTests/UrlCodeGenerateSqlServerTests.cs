...
//  Author           : RzR
//  Created On       : 2024-10-24 21:29
// 
//  Last Modified By : RzR
//  Last Modified On : 2024-10-24 21:29
// ***********************************************************************
//  <copyright file="UrlCodeGenerateSqlServerTests.cs" company="">
...
{
    [TestClass]
    public class UrlCodeGenerateSqlServerTests
    {
        ...
        public void Init()
        {
            var dbConnectionString = File.ReadAllText("H:\\DataBases\\localhost_SqlServer_connectionString.txt");
